...
document.getElementById('sidebar_btn').addEventListener("click", (e)=>{
    ...
    //document.getElementById('sidebar_btn').style.marginLeft = style.width.substring(0, style.width.length-2) < 2 ? "0px" : "20px";

    icon_control_btn.style.position = "static";
    $(icon_control_btn).animate({left:'750px'}, 'fast');
